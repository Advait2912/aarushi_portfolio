  ...
  },
  {
    ...
    desc: (
      <>
        ...
        <br />
        Mapping helps me move from confusion to clarity. Visualise the system. Make invisible relationships visible and navigable.
      </>
    ),
  },
  {
  ...
  return (
    <section id="split-mind" className="split-mind" ref={ref}>
      ...
      <div className="logic-side">
        ...
        <div
          className="process-steps fade-up"
      ...
      <div className="chaos-side">
        ...
        <p
          ...
          style={{ top: "22%", left: "40%", transform: "rotate(45deg)" }}
        >
          ↗
        </p>
        <p
          className="chaos-arrow"
          style={{ top: "50%", left: "70%", transform: "rotate(-20deg)" }}
        >
          ↙
        </p>
        <p
          className="chaos-arrow"
          style={{ top: "75%", left: "35%", transform: "rotate(10deg)" }}
        >
          →
        </p>
